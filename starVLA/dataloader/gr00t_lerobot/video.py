...
def _open_pyav_low_mem(video_path: str) -> av.container.InputContainer:
    """Open a video with PyAV using minimal memory (single-threaded FFmpeg decode)."""
...
def get_frames_by_indices(
    ...
    if video_backend == "decord":
        ...
        container = None
        try:
            container = _open_pyav_low_mem(video_path)
            stream = container.streams.video[0]
            ...
            for target_idx in indices:
                ...
                for frame in container.decode(video=0):
                    ...
                    if current_diff < closest_idx_diff:
                        ...
                        best_data = frame.to_ndarray(format="rgb24")
                ...
                if best_data is not None:
                    loaded_frames.append(best_data)
                else:
