...
class DiT(ModelMixin, ConfigMixin):
    ...
    # register_to_config stores constructor arguments under self.config.
    @register_to_config
    def __init__(
        self,
        ...
        **kwargs
        ...
        # Timestep encoder
        # compute_dtype may be absent from older configurations.
    ...
    def forward(
        ...
        for idx, block in enumerate(self.transformer_blocks):
            ...
            block_encoder_hidden_states = None if use_self_attn else encoder_hidden_states
            block_encoder_attention_mask = None if use_self_attn else encoder_attention_mask
