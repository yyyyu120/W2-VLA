...
# Clean-only RoboTwin, 50-step action chunk, GR00T action head.
...
config_yaml=${config_yaml:-./examples/Robotwin/train_files/starvla_cotrain_robotwin_groot_clean_50.yaml}
run_root_dir=${run_root_dir:-./results/Checkpoints}
data_mix=${data_mix:-robotwin_clean_50}
run_id=${run_id:-robotwin_clean_50chunk_qwen3GR00T}
