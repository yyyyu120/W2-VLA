...
# Clean-only RoboTwin, 16-step action chunk, GR00T action head.
# "robotwin_clean_h16" uses the same clean task directories as "robotwin",
# but keeps the 16-step robotwin action_indices instead of robotwin50.
...
run_id=${run_id:-robotwin_clean_h16_qwen3GR00T}
