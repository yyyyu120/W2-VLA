...
# Source-like StarVLA-GR00T LIBERO baseline entry for a 5-GPU machine.
# This keeps the source script's per-GPU batch, optimizer-step count, and save
# cadence. The only intended hardware-side difference is 5 GPUs instead of 8.
...
run_id=${run_id:-starvla_gr00t_libero_repro_5gpu_bs16_80k}
