...
<a href="https://huggingface.co/yuuu94/W2-VLA/tree/main/LIBERO"><img src="https://img.shields.io/badge/%F0%9F%A4%97%20Hugging_Face-Model-yellow" alt="W2-VLA model"></a>
...
Download the released checkpoint and its inference configuration:

```bash
hf download yuuu94/W2-VLA \
  --include "LIBERO/*" \
  --local-dir playground/Pretrained_models/W2-VLA
```
